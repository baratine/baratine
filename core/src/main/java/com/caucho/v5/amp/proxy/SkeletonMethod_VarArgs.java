 ...
 */
class SkeletonMethod_VarArgs extends SkeletonMethodBase
{
  private static final L10N L = new L10N(SkeletonMethod_VarArgs.class);
  private static final Logger log
  = Logger.getLogger(SkeletonMethod_VarArgs.class.getName());
  ...
  SkeletonMethod_VarArgs(ServiceManagerAmp rampManager,
                         Method method)
