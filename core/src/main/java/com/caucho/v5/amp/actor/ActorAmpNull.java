 ...
 * Null actor
 */
public class ActorAmpNull extends ActorAmpBase implements ActorAmpState
{
  private static final L10N L = new L10N(ActorAmpNull.class);
  private static final Logger log = Logger.getLogger(ActorAmpNull.class.getName());
  
  private final String _address;
  
  public ActorAmpNull(String address)
  {
    _address = address;
  }
