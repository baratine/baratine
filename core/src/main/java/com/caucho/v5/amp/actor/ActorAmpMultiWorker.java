 ...
 */
public class ActorAmpMultiWorker extends ActorAmpStateBase
{
  private final ActorAmp _delegate;
  
  public ActorAmpMultiWorker(ActorAmp delegate)
  {
    _delegate = delegate;
  }
  
  private ActorAmp getDelegate()
  {
    return _delegate;
  }
