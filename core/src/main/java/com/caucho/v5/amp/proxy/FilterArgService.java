...
public class FilterArgService
{
  ...
  FilterArgService(ServiceManagerAmp manager,
                       Class<?> api)
  {
    _manager = manager;
    _api = api;
  ...
  public Object filter(Object arg)
  {
    ...
    throw new IllegalArgumentException(L.l("Argument {0} is invalid because callback class {1} requires a matching argument or a string address.",
                                           arg,
                                           _api.getName()));
  }
}
