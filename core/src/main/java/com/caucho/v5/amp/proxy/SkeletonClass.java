...
import com.caucho.v5.amp.actor.MethodAmpNull;
...
public class SkeletonClass
{
  ...
  private static final Logger log
    = Logger.getLogger(SkeletonClass.class.getName());
  ...
  public SkeletonClass(ServiceManagerAmp rampManager,
                       Class<?> api,
                       ServiceConfig config)
  {
    ...
    if (ActorAmp.class.isAssignableFrom(api)) {
      throw new IllegalStateException(String.valueOf(api));
    }
  ...
  public MethodAmp getMethod(ActorAmp actor, String methodName)
  {
  ...
  protected MethodAmp createMethodBase(Method method)
  {
    try {
      ...
      if (isResult(paramTypes, Result.class)) {
        if (method.isVarArgs()) {
          return new SkeletonMethodResult_VarArgs(method);
        }
        else {
          return new SkeletonMethodResult_N(method);
        }
      }
      
      if (isResult(paramTypes, ResultStream.class)) {
        if (false && method.isVarArgs()) {
          return new SkeletonMethodResult_VarArgs(method);
        }
        else {
          return new SkeletonMethodResultStream_N(method);
        }
      }
      ...
      */
      ...
      if (method.isVarArgs()) {
        return new SkeletonMethod_VarArgs(_ampManager, method);
      }
    
      switch (paramTypes.length) {
      case 0:
        return new SkeletonMethod_0(_ampManager, method);
        
      case 1:
        return new SkeletonMethod_1(_ampManager, method);
      
      default:
        return new SkeletonMethod_N(_ampManager, method);
      }
    } catch (RuntimeException e) {
      throw e;
    } catch (Exception e) {
  ...
  private MethodAmp getActorMethod(ActorAmp actor,
                                         String methodName)
  {
    try {
      Object bean = ((ActorAmpBean) actor).bean();
      ...
      return new SkeletonCustomMethod(actor, ampMethod);
    } catch (Throwable e) {
      e.printStackTrace();
      throw new AmpException(e);
    }
  ...
  private boolean isResult(Class<?> []paramTypes, Class<?> resultClass)
  {
  ...
  public void beforeBatch(ActorAmp actor)
  {
  ...
  public void onActive(ActorAmp actor, Result<? super Boolean> result)
  {
    try {
  ...
  public void onInit(ActorAmp actor, Result<? super Boolean> result)
  {
    try {
  ...
  */
  ...
  public void checkpointStart(ActorAmp bean, Result<Boolean> result)
  {
    try {
  ...
  public Object onLookup(ActorAmp bean, String path)
  {
  ...
  public void onLoad(ActorAmp actor, Result<?> result)
  {
  ...
  public void consume(ActorAmp bean, ServiceRef serviceRef)
  {
  ...
  public void subscribe(ActorAmp bean, ServiceRef serviceRef)
  {
  ...
  public void unsubscribe(ActorAmp bean, ServiceRef serviceRef)
  {
  ...
  public void shutdown(ActorAmp actor,
