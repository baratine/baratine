 ...
 */
class SkeletonMethodResultOutPipe_N extends SkeletonMethodResult_N
{
  private static final L10N L = new L10N(SkeletonMethodResultOutPipe_N.class);
  private static final Logger log
  = Logger.getLogger(SkeletonMethodResultOutPipe_N.class.getName());

  SkeletonMethodResultOutPipe_N(Method method) throws IllegalAccessException
  {
    super(method);
  }
