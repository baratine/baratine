 ...
 */
public class ProxyGeneratorVault<T>
{
  private static final L10N L = new L10N(ProxyGeneratorVault.class);
  private static final Logger log 
    = Logger.getLogger(ProxyGeneratorVault.class.getName());
  ...
  ProxyGeneratorVault(Class<T> type,
                           ClassLoader loader)
  {
