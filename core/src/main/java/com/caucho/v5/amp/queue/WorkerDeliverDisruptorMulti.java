 ...
 */
public final class WorkerDeliverDisruptorMulti<M extends MessageDeliver>
  extends WorkerDeliverBase<M>
{
  private static final Logger log
    = Logger.getLogger(WorkerDeliverDisruptorMulti.class.getName());
  ...
  public WorkerDeliverDisruptorMulti(Deliver<M> deliver,
  ...
  public void runImpl(OutboxDeliver<M> outbox, M msg)
  {
    ...
    final WorkerDeliver tailWorker = _tailWorker;
    
    try {
      actor.beforeBatch();

      try {
        queue.deliverMulti(actor,
                           outbox,
                           _headCounter,
                           _tailCounter,
                           tailWorker);
