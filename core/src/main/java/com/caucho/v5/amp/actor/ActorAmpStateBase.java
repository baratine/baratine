 ...
 */
public class ActorAmpStateBase extends ActorAmpBase implements ActorAmpState
{
  private static final Logger log
    = Logger.getLogger(ActorAmpStateBase.class.getName());
  ...
  private class PendingMessages
  {
    ...
    void deliverReplay(InboxAmp inbox)
    {
      ...
      for (MessageAmp msg : pendingMessages) {
        try {
          msg.invoke(inbox, ActorAmpStateBase.this);
        } catch (Exception e) {
          e.printStackTrace();
    ...
    void deliverSave()
    {
      ...
      if (saveResult != null) {
        ...
        loadState().onSave(ActorAmpStateBase.this, saveResult);
      }
    }
