...
public enum LoadStateActorAmp implements LoadState
{
  NEW {
    ...
    @Override
    public void flushPending(StubAmp actor, InboxAmp inbox)
    {
    }
  },
  ...
  INIT_REPLAY {
    ...
    @Override
    public LoadStateActorAmp toActive(StubAmp actor)
    {
  ...
  REPLAY {
    ...
    @Override
    public void onActive(StubAmp actor, InboxAmp inbox)
    {
  ...
  REPLAY_MODIFY {
    ...
    public LoadState load(StubAmp actor,
                          ...
                          MessageAmp msg)
    {
      StubAmpStateBase actorBean = (StubAmpStateBase) actor;
    ...
    public void flushPending(StubAmp actor, InboxAmp inbox)
    {
      StubAmpStateBase actorBase = (StubAmpStateBase) actor;
  ...
  ACTIVE {
    ...
    @Override
    public void onModify(StubAmp actor)
    {
      StubAmpStateBase actorBean = (StubAmpStateBase) actor;
  ...
  MODIFY {
    @Override
    public void onSave(StubAmp actor, SaveResult saveResult)
    {
      ActorAmpState actorBean = (ActorAmpState) actor;
  ...
  DESTROY {
    ...
    @Override
    public void outPipe(StubAmp actorDeliver,
                        StubAmp actorMessage,
                        MethodAmp method,
                        HeadersAmp headers,
  ...
  @Override
  public void shutdown(StubAmp actor, ShutdownModeAmp mode)
  {
    ActorAmpState actorBase = (ActorAmpState) actor;
