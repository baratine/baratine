 ...
 */
class SkeletonMethodResult_N extends SkeletonMethodBase {
  private static final Logger log
  = Logger.getLogger(SkeletonMethodResult_N.class.getName());
  ...
  SkeletonMethodResult_N(Method method) throws IllegalAccessException
  {
    super(method);
    ...
    _methodHandle = initMethodHandle(method);
  }
  ...
  protected MethodHandle initMethodHandle(Method method)
